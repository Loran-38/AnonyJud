...
const HomePage = () => {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Hero Section */}
      <section className="relative flex items-center justify-center text-center h-[80vh]">
        {/* Image d'arrière-plan libre de droit (Unsplash) */}
        <img 
          src="https://images.unsplash.com/photo-1528740561666-dc2479dc08c3?auto=format&fit=crop&w=1600&q=80" 
          alt="Justice background" 
          className="absolute inset-0 w-full h-full object-cover opacity-40" 
        />
        {/* Overlay dégradé pour garder la palette de couleurs */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-indigo-100 opacity-90"></div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              to="/signup" 
              className="bg-white hover:bg-gray-50 text-blue-600 px-8 py-3 rounded-lg font-semibold border-2 border-blue-600 shadow-md transition-colors"
            >
